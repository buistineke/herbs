...
if ( ! function_exists( 'herbs_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function herbs_posted_on() {
...
if ( ! function_exists( 'herbs_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function herbs_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'herbs' ),
...
if ( ! function_exists( 'herbs_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function herbs_entry_footer() {
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'herbs' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'herbs_post_thumbnail' ) ) :
	/**
